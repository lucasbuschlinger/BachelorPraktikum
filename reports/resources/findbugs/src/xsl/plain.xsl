...
<xsl:stylesheet version="1.0"
        ...
        <html>
            ...
            <body>
                ...
                <table width="500" cellpadding="5" cellspacing="2">
                    ...
                    <xsl:variable name="styleclass">
                        <xsl:choose>
                            <xsl:when test="count($unique-catkey) mod 2 = 0">
                                tablerow0
                            </xsl:when>
                            <xsl:otherwise>tablerow1</xsl:otherwise>
                        </xsl:choose>
                    ...
                    <tr class="{$styleclass}">
                        ...
                        <td align="right">
                            <b>
                                <xsl:value-of
                                        select="count(/BugCollection/BugInstance[not(@last)])"/>
                            </b>
                        </td>
                    </tr>
                </table>
    ...
    <xsl:template name="generateWarningTable">
        ...
        <table class="warningtable" width="100%" cellspacing="2"
               cellpadding="5">
