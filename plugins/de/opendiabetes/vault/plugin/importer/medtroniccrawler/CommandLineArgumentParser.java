...
public class CommandLineArgumentParser {
     ...
     *
     * Decreasing this also decreases startup time and
    ...
    public void runDifferentArguments(final String[] args, final Logger logger)
        ...
        // If there are any arguments provided, program will go further and
        ...
        if (commandLine.getOptions().length != 0) {
            if (commandLine.getOptions()[0].getOpt() == "h") {
                System.out.println("Version: Carelink Crawler v0.1\n" + "Options: "
                        ...
                        + "   -medtroniccrawler				starts in medtroniccrawler mode. -from and -to is required.\n"
                        ...
                        + " -u,--upload\n"
                        + "   Combination to run medtroniccrawler program : java -jar XYZ.jar -c,--config completepathwithfilename "
                        + "-medtroniccrawler -from 15/05/2017 -to 20/06/2017 --output outputfolderpath \n"
                        + "Date Format:\n"
                        + "English: DD/MM/YYYY\n"
                        + "German: DD.MM.YYYY\n");
        ...
        Option crawlerOptions = Option.builder("medtroniccrawler").required(false).desc("The Crawler option").build();
        ...
        try {
            ...
            // Testing Upload section
                ...
                /****************************************
                 * Testing Download i.e medtroniccrawler section


                if (commandLine.getOptions().length > 1) {
                    if (((commandLine.getOptions()[0].getOpt() == "test")
                            && (commandLine.getOptions()[1].getOpt() == "medtroniccrawler"))
                            || ((commandLine.getOptions()[0].getOpt() == "medtroniccrawler")
                            && (commandLine.getOptions()[1].getOpt() == "test"))) {
            ...
            */
            ...
            if (!commandLine.hasOption("from") || !commandLine.hasOption("to") || !commandLine.hasOption("medtroniccrawler")) {
                tempCounterForThrowingError++;
                return;
            }
            ...
            // }
            try {
                logger.info("Inside logic for checking config file availabe for medtroniccrawler");
